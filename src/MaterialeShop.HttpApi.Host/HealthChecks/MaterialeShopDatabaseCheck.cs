...
public class MaterialeShopDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public MaterialeShopDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
